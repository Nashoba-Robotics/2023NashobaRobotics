package frc.robot.commands.auto.routines.red;
...
public class REDRightTo3ToScoreAuto extends SequentialCommandGroup{
    public REDRightTo3ToScoreAuto(){
        ...
        PathPlannerTrajectory path = PathPlanner.loadPath("RED-rightC-3-rightA", new PathConstraints(2, 2));
