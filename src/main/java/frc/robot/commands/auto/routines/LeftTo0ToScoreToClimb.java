...
public class LeftTo0ToScoreToClimb extends SequentialCommandGroup{
    
    public LeftTo0ToScoreToClimb() {
        ...
        List<PathPlannerTrajectory> path = PathPlanner.loadPathGroup("leftA-0-leftC-climb",
