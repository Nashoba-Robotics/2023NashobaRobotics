...
public class REDLeftTo0ToScore extends SequentialCommandGroup{
    
    public REDLeftTo0ToScore() {
        ...
        PathPlannerTrajectory path = PathPlanner.loadPath("RED-leftA-0-leftC", new PathConstraints(2, 2));
